...
class ArticleServiceTest {
    ...
    @Test
    void givenNoSearchParameters_whenSearchArticlesViaHashtag_thenReturnEmptyPage() {
    ...
    @Test
    void givenHashtag_whenSearchArticlesViaHashtag_thenReturnArticlesPage() {
    ...
    @DisplayName("해시태그를 조회하면, 유니크 해시태그 리스트를 조회한다.")
    @Test
    void givenNothing_whenCall_thenReturnHashtags() {
        ...
        List<String> articleHashtags = sut.getHashtags();

        assertThat(articleHashtags).isEqualTo(expectedHashtag);
    ...
    void givenNonexistentArticleId_whenSearchingArticleWithComments_thenThrowsException() {
        ...
        assertThat(t)
                ...
                .hasMessage("게시글을 찾을 수 없습니다. - articleId: " + articleId);
        then(articleRepository).should().findById(articleId);
    }
